...
def display_menu():
    ...
    print("6. Compile Plugin Debug Build (Windows x86_64)")
    print("7. Compile Plugin Release Build (Windows x86_64)")
...
def handle_option(choice):
    ...
    script_map = {
        ...
        "6": "compile_windows_debug_build.py",
        "7": "compile_windows_release_build.py",
    }
